...
if __name__ == '__main__':
    exp_names = [
        'experiments/mnist/random_samplewise/MNIST-eps=8',
        'experiments/mnist/min-min_samplewise/MNIST-eps=8-se=0.1-base_version=resnet18',
        'experiments/mnist/min-min_samplewise/MNIST-eps=8-se=0.01-base_version=resnet18',
