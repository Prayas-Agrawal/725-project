...
# Datasets Options
parser.add_argument('--train_data_type', type=str, default='MNIST')
parser.add_argument('--test_data_type', type=str, default='MNIST')
...
parser.add_argument('--noise_shape', default=[1, 1, 28, 28], nargs='+', type=int, help='noise shape')
